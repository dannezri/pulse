...
> **Note** : Tous les chemins sont relatifs au dossier `mobile/` (ex: `mobile/app/(tabs)/index.tsx`)
...
2. Vérifier que le fichier `mobile/ios/app/app.entitlements` contient la capability HealthKit
